...
namespace MC {
	namespace Graphics {
		...
		public:
			...
			void Set2x2(const std::string& name, const glm::mat2& value);
			void Set3x3(const std::string& name, const glm::mat3& value);
			void Set4x4(const std::string& name, const glm::mat4& value);
		private:
