...
#define MC_JOYSTICK_1             0
#define MC_JOYSTICK_2             1
#define MC_JOYSTICK_3             2
#define MC_JOYSTICK_4             3
#define MC_JOYSTICK_5             4
#define MC_JOYSTICK_6             5
#define MC_JOYSTICK_7             6
#define MC_JOYSTICK_8             7
#define MC_JOYSTICK_9             8
#define MC_JOYSTICK_10            9
#define MC_JOYSTICK_11            10
#define MC_JOYSTICK_12            11
#define MC_JOYSTICK_13            12
#define MC_JOYSTICK_14            13
#define MC_JOYSTICK_15            14
#define MC_JOYSTICK_16            15
#define MC_JOYSTICK_LAST          MC_JOYSTICK_16

#define MC_GAMEPAD_BUTTON_A               0
#define MC_GAMEPAD_BUTTON_B               1
#define MC_GAMEPAD_BUTTON_X               2
#define MC_GAMEPAD_BUTTON_Y               3
#define MC_GAMEPAD_BUTTON_LEFT_BUMPER     4
#define MC_GAMEPAD_BUTTON_RIGHT_BUMPER    5
#define MC_GAMEPAD_BUTTON_BACK            6
#define MC_GAMEPAD_BUTTON_START           7
#define MC_GAMEPAD_BUTTON_GUIDE           8
#define MC_GAMEPAD_BUTTON_LEFT_THUMB      9
#define MC_GAMEPAD_BUTTON_RIGHT_THUMB     10
#define MC_GAMEPAD_BUTTON_DPAD_UP         11
#define MC_GAMEPAD_BUTTON_DPAD_RIGHT      12
#define MC_GAMEPAD_BUTTON_DPAD_DOWN       13
#define MC_GAMEPAD_BUTTON_DPAD_LEFT       14
#define MC_GAMEPAD_BUTTON_LAST            MC_GAMEPAD_BUTTON_DPAD_LEFT

#define MC_GAMEPAD_BUTTON_CROSS       MC_GAMEPAD_BUTTON_A
#define MC_GAMEPAD_BUTTON_CIRCLE      MC_GAMEPAD_BUTTON_B
#define MC_GAMEPAD_BUTTON_SQUARE      MC_GAMEPAD_BUTTON_X
#define MC_GAMEPAD_BUTTON_TRIANGLE    MC_GAMEPAD_BUTTON_Y

#define MC_GAMEPAD_AXIS_LEFT_X        0
#define MC_GAMEPAD_AXIS_LEFT_Y        1
#define MC_GAMEPAD_AXIS_RIGHT_X       2
#define MC_GAMEPAD_AXIS_RIGHT_Y       3
#define MC_GAMEPAD_AXIS_LEFT_TRIGGER  4
#define MC_GAMEPAD_AXIS_RIGHT_TRIGGER 5
#define MC_GAMEPAD_AXIS_LAST          MC_GAMEPAD_AXIS_RIGHT_TRIGGER