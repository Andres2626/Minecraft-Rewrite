...
namespace MC {
	namespace Graphics {
		...
		public:
			 ...
			 * position and dir is the camera direction. To use the ray it is necessary 
			 * to configure the maximum size of the ray segment and step (t) is the 
			 * distance at which the position to which the ray points is evaluated by 
			 * means of a for loop.
			 *
